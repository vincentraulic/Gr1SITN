...
<html>
	...
	<body>
		...
		<iframe src="" id="spelltext" name="spelltext" style="border: none; display:none; width: 100%" ></iframe>
		<iframe src="" id="loadsuggestfirst" name="loadsuggestfirst" style="border: none; display:none; width: 100%" ></iframe>
		<iframe src="" id="loadspellsuggestall" name="loadspellsuggestall" style="border: none; display:none; width: 100%" ></iframe>
		<iframe src=""id="loadOptionsForm" name="loadOptionsForm" style="border: none; display:none; width: 100%" ></iframe>
		<script>
		(function(window) {
